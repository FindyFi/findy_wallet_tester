...
SCREEN_ID = (AppiumBy.XPATH, '//*[@text="TODO: sphereon credential offer heading"]')

# TODO: replace with the locator for the Accept / Add button.
_ACCEPT = (AppiumBy.XPATH, '//*[@text="TODO: sphereon accept button"]')

# TODO: replace with the locator for the Decline / Cancel button.
_DECLINE = (AppiumBy.XPATH, '//*[@text="TODO: sphereon decline button"]')
